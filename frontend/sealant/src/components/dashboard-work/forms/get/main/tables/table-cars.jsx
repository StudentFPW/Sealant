                        ...
                        <tr key={index}>
                            ...
                            <td>
                                <a href={`/vehicle/${cars.vehicle_model.id}`}>
                                    {cars.vehicle_model['name'] ? cars.vehicle_model['name'] : 'Не указано !'}
                                </a>
                            </td>

                            <td>
                                <a href={`/engine/${cars.engine_model.id}`}>
                                    {cars.engine_model['name'] ? cars.engine_model['name'] : 'Не указано !'}
                                </a>
                            </td>
                            ...
                            <td>
                                <a href={`/transmission/${cars.transmission_model.id}`}>
                                    {cars.transmission_model['name'] ? cars.transmission_model['name'] : 'Не указано !'}
                                </a>
                            </td>
                            ...
                            <td>
                                <a href={`/driveaxle/${cars.drive_axle_model.id}`}>
                                    {cars.drive_axle_model['name'] ? cars.drive_axle_model['name'] : 'Не указано !'}
                                </a>
                            </td>
                            ...
                            <td>
                                <a href={`/steeringaxle/${cars.steering_axle_model.id}`}>
                                    {cars.steering_axle_model['name'] ? cars.steering_axle_model['name'] : 'Не указано !'}
                                </a>
                            </td>
                            ...
                            <td title={cars.delivery_address ? cars.delivery_address : ''}>
                                {cars.delivery_address ? cars.delivery_address.slice(0, 15) + '...' : 'Не указано !'}
                            </td>

                            <td title={cars.equipment ? cars.equipment : ''}>
                                {cars.equipment ? cars.equipment.slice(0, 15) + '...' : 'Не указано !'}
                            </td>
                            ...
                            {props.staffstatus === "allow" ? <td>
                                <button
                                    type="button"
                                    onClick={() => { history.push(`/updatecar/${cars.id}`) }}
